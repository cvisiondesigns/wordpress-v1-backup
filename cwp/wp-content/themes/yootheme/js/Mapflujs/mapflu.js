...
var ParticleEngine = (function() {
	...
	function ParticleEngine(canvas_id) {
		...
		this.particleSettings = [{id:"small", num:10, fromX:0, toX:this.totalWidth, ballwidth:3, alphamax:0.4, areaHeight:.5, color:"#ffffff", fill:false}, 
								{id:"medium", num:30, fromX:0, toX:this.totalWidth,  ballwidth:8, alphamax:0.8, areaHeight:1, color:"#ffffff", fill:true}, 
								{id:"large", num:10, fromX:0, toX:this.totalWidth, ballwidth:30,  alphamax:0.7, areaHeight:1, color:"#ffffff", fill:true}];
		this.particleArray = [];
		this.lights = [{ellipseWidth:400, ellipseHeight:100, alpha:0.6, offsetX:0, offsetY:0, color:"#FFCD7D"}, 
						{ellipseWidth:350, ellipseHeight:250, alpha:0, offsetX:-50, offsetY:0, color:"#FFE2B4"}, 
						{ellipseWidth:100, ellipseHeight:80, alpha:0, offsetX:80, offsetY:-50, color:"#ffffff"}];
